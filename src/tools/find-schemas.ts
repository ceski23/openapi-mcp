...
export const findSchemas = defineTool({
    ...
    title: 'Find Schemas',
    description:
        'Search component/definition schema names in the loaded spec by matching against schema names. Use when you know approximately what a schema is called but not the exact name. Returns paginated results with {total, page, limit, results: [{name, type?, description?}]}',
    inputSchema: z
        .object({
            specId: z
                .string()
        ...
        .strict()
        .meta({ title: 'Find Schemas Parameters' }),
